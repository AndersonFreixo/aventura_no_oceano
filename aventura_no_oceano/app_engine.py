...
from aventura_no_oceano.engine import minigui, music_player
from aventura_no_oceano.game import entity
from aventura_no_oceano.data import levels
from aventura_no_oceano.common.constants import *
from aventura_no_oceano.game import state
...
class Engine:
	def __init__(self):
		...
		self.soundtrack = ["aventura_no_oceano/resources/sound/st_01.ogg",
	...
	def init_sounds(self):
		self.sounds["select"] = pygame.mixer.Sound("aventura_no_oceano/resources/sound/select.ogg")
		self.sounds["click"] = pygame.mixer.Sound("aventura_no_oceano/resources/sound/click-cut.ogg")
		self.sounds["eat"] = pygame.mixer.Sound("aventura_no_oceano/resources/sound/chomp-cut.ogg")
		self.sounds["hurt"] = pygame.mixer.Sound("aventura_no_oceano/resources/sound/hurt.ogg")
		self.sounds["gameover"] = pygame.mixer.Sound("aventura_no_oceano/resources/sound/game_over2.ogg")
